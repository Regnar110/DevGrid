export const animateSVG = () => {! function(t, n) {
        ...
        N = function() {
            ...
            return u(t, [{
                ...
                value: function(t, n) {
                    if (n %= 360, (t %= 360) || n) {
                        var e = this.m,
                            ...
                            u = e[2],
                            o = e[3];
                        t && (t = M(t * I), e[2] += r * t, e[3] += i * t), n && (n = M(n * I), e[0] += u * n, e[1] += o * n), this.w = this.s = this.i = null
                    }
                    return this
                }
            }, {
                ...
                value: function() {
                    ...
                    i[1][0] /= l, i[1][1] /= l, a /= l;
                    var s = 0;
                    return i[1][1] < 0 ? (s = j(i[1][1]) * R, i[0][1] < 0 && (s = 360 - s)) : s = E(i[0][1]) * R, o && (s = -s), a = P(a, F(i[0][0] * i[0][0] + i[0][1] * i[0][1])) * R, o && (a = -a), {
                        origin: {
                            x: d(e[4]),
                            y: d(e[5])
                        },
    ...
    var lt = [{
        ...
        st = function() {
            function t(n, e) {
                ...
                r(this, t), this._id = 0, this._running = !1, this._rollingBack = !1, this._animations = n, this._settings = e, (!u || u < "2022-05-02") && delete this._settings.speed, lt.forEach((function(t) {
            ...
            return u(t, [{
                ...
                key: "build",
                value: function(t, n) {
                    delete t.animationSettings, t.options = at(t.options, t.root, "5c7f360c"), t.animations.map((function(n) {
                        n.settings = at(n.s, t.root, "5c7f360c"), delete n.s, t.animationSettings || (t.animationSettings = n.settings)
                    }));
                    var e = t.version;
    ...
    function mt(t) {
        var n = function() {
            ...
            return t && t.style ? (t.style.position = "absolute", t.style.opacity = "0.01", t.style.zIndex = "-9999", t.style.left = "-9999px", t.style.width = "1px", t.style.height = "1px", pt = {
                svg: t
            }) : {}
        }().svg;
    ...
    function zt(t, n, r, i, u, o, a, l) {
        return Vt(t, 0, l), n = function(t, n, e) {
            ...
            function(i) {
                ...
                if ("g" === u.t) {
                    ...
                    return function(t, n) {
                        ...
                        for (var u = 0, o = e.length, a = n.length - 1; u < o; u++) e[u].setAttribute("stop-color", ht(n[Math.min(u, a)].c)), e[u].setAttribute("offset", n[Math.min(u, a)].o)
                    }(o, u.s), Object.keys(Gt).forEach((function(t) {
                        if (void 0 !== u[t])
                            if ("object" !== e(Gt[t])) {
                                var n, r = "gt" === t ? (n = u[t], Array.isArray(n) ? "matrix(" + n.join(" ") + ")" : "") : u[t],
                                    i = Gt[t];
                                o.e.setAttribute(i, r)
                            } else Object.keys(Gt[t]).forEach((function(n) {
                                if (void 0 !== u[t][n]) {
                                    var e = u[t][n],
                                        r = Gt[t][n];
                ...
                case "g":
                    if (e.r === r.r) {
                        ...
                        return e.gt && r.gt && (u.gt = function(t, n, e) {
                            ...
                            return i
                        }(t, e.gt, r.gt)), e.c ? (u.c = L(t, e.c, r.c), u.rd = q(t, e.rd, r.rd)) : e.f && (u.f = L(t, e.f, r.f), u.to = L(t, e.to, r.to)), u
                    }
            }
...
(function(s, i, o, w, d, a, b) {
    ...
    "animations": [{
                ...
                "transform": {
                    ...
                    "keys": {
                        "o": [{
                            ...
                            "v": {
                                "x": 204.2315198613957,
                                "y": 318.39522242956696,
                                "a": -146.34549253519288
                            }
                        }]
                    }
                }
                ...
                "transform": {
                    ...
                    "keys": {
                        "o": [{
                            ...
                            "v": {
                                "x": 607.6454669113623,
                                "y": 231.40417983997622,
                                "a": -165.88080621495521
                            }
                        }]
                    }
                }
        ...
        "s": "|"
    }],
    "options": "MYDAxMDg4MmY4MFA4MTQZlN2Y4MTJmNDcyZjcP5N2M2ZTcxMmY4YQ|"
