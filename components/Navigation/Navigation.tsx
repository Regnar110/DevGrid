...
const Navigation = () => {
  ...
  return isMounted ? 
    <div className={`site_desktop_navbar fixed z-50 w-full flex justify-end flex-row-reverse md:grid grid-cols-2  md:grid-cols-5 items-center  ${isNavActive ? "h-[60px] border-[1px] shadow-xl bg-[#fff]": "h-[0px]"} overflow-hidden transition-all duration-200 `}>
