...
const HearthSVGPart = () => {
  ...
  return (
    <animated.g style={groupSpringValues}>
        <animated.path fillRule="evenodd" clipRule="evenodd" d="M393 51L459 39C461 38 463 40 463 42L475 106C475 107 474 109 472 110L451 113L442 128L428 118L407 122C405 122 403 121 403 119L391 55C390 53 392 51 393 51Z" fill="#15BFFD"/>
