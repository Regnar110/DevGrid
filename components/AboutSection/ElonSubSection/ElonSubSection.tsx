...
const ElonSubSection = () => {
  return (
    <div className='relative half_bg_color-black grid md:grid-cols-3 items-center justify-items-center w-full text-white gap-8 md:gap-0 mt-28 overflow-visible'>
